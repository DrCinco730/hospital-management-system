...
//        return response()->json($appointments);
        ...
        return view('pharmacyDashboard', ['medicines' => $medicines, 'orders' => $appointments]);
    }
    ...
    public function addMedication(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'medicineName.required' => 'Please enter the medication name.',
                'medicineName.max' => 'The medication name must not exceed 255 characters.',
                'medicineName.unique' => 'This medication already exists.',
                ...
                'medicineType.required' => 'Please specify the type of medication.',
            ...
            if ($validator->fails()) {
                return redirect()->back()->withErrors($validator)->withInput()->with('showForm', 'medicineForm');
            }
